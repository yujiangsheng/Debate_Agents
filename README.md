...
基于 **Qwen2.5-7B-Instruct** 的多智能体辩论系统。两个AI智能体从对立角度激烈辩论，裁判进行犀利评判，最终输出共识点和分歧点。

**作者**: Jiangsheng Yu | **版本**: 2.0
...
| 特性 | 说明 |
|------|------|
| 🤖 **对抗式辩论** | 正方A vs 反方B 激烈对抗，立场坚定不动摇 |
| ⚔️ **立场强化** | 智能体绝不帮对方说话，结论必须支持己方 |
| ⚖️ **犀利裁判** | 尖锐评判，明确判定胜负，不和稀泥 |
| 🤝 **共识提炼** | 自动总结共识点和分歧点 |
| 📊 **结构化追踪** | JSON格式记录双方观点，防止混淆 |
